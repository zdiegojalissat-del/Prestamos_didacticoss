...
const firebaseConfig = {
    apiKey: "AIzaSyDJ4aCJpQlZ3BERZTZ3nrUTRqSTcKUrwhs",
    authDomain: "prestamos-didactico.firebaseapp.com",
    databaseURL: "https://prestamos-didactico-default-rtdb.firebaseio.com",
    projectId: "prestamos-didactico",
    storageBucket: "prestamos-didactico.firebasestorage.app",
    messagingSenderId: "749543794069",
    appId: "1:749543794069:web:c5c68b066fd5ae1d13029c"
};
